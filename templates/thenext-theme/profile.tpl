                    ...
                    <div class="agent agent-page long-content">
                        ...
                        <div class="agent-content">
                            ...
                            <ul class="agent-contact-details">
                                ...
                                {:IF}
                                IF("{PHONE}"!=""){
                                    <li class="tg-btnphone"><i class="icon-feather-phone-call"></i><span data-last="{PHONE}"><a href="tel:{PHONE}" rel="nofollow"><em>{LANG_SHOW_PHONE_NO}</em></a></span>
                                        IF("{PHONE_VERIFY}"=="1"){
                                        <img src="{SITE_URL}templates/{TPL_NAME}/images/verified-badge.png" data-tippy-placement="top" title="{LANG_VERIFIED}" width="16px"/>
                                        {:IF}
                                    </li>
                                {:IF}
                                IF("{EMAIL}"!=""){
                                    <li class="tg-btnphone"><i class="icon-feather-mail"></i><span data-last="{EMAIL}"><a href="mailto:{EMAIL}" rel="nofollow"><em>{LANG_SHOW_EMAIL}</em></a></span></li>
                                {:IF}
                                IF("{WEBSITE}"!=""){
                    ...
                    {LOOP: ITEM}
                        <div class="job-listing IF({ITEM.highlight}){ highlight {:IF}">
                            ...
                            <div class="job-listing-footer">
                                <ul>
                                    <li><i class="la la-user"></i> <a href="{LINK_PROFILE}/{ITEM.username}">{ITEM.username}</a></li>
