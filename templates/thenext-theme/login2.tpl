                    ...
                    <div class="row mt-6 mb-6">
                        <div class="col-6 align-items-center d-flex" >
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label" for="remember">{LANG_REMEMBER_ME}</label>
                            </div>
                        </div>
                        <div class="col-6 text-right"><a href="#" class="forgot-page">{LANG_FORGOTPASS}</a></div>
                    </div>
...
<script>
    ...
    var LANG_PHONE_VERIFIED_MSG = "{LANG_PHONE_VERIFIED_MSG}";
    var LANG_AUTHENTICATING = "{LANG_AUTHENTICATING}";
    var LANG_CHECKEMAILFORGOT = "{LANG_CHECKEMAILFORGOT}";
</script>
