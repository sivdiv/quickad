        ...
        <div class="card">
            ...
            <div class="card-block">
                ...
                <div id="js-table-list">
                    <table class="js-table-checkable table table-vcenter table-hover responsive" id="ajax_datatable" data-jsonfile="post.php?status=active">
                        <thead>
                        <tr>
                            <th class="w-5 sortingNone">
