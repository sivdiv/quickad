                    ...
                    <form name="form2"  class="form" method="post" data-ajax-action="addMembershipPlan" id="sidePanel_form">
                        <div class="form-body">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-6">
                                    <input name="featured_project_fee" type="number" class="form-control" id="featured_project_fee" value="5">
                                </div>
                            </div>
                            <div class="row form-group">
                                <label class="col-sm-4 control-label">Featured Duration</label>
                                <div class="col-sm-6">
                                    <input name="featured_duration" type="Text" class="form-control" id="featured_duration" value="30">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-6">
                                    <input name="urgent_project_fee" type="number" class="form-control" id="urgent_project_fee" value="5">
                                </div>
                            </div>
                            <div class="row form-group">
                                <label class="col-sm-4 control-label">Urgent Duration</label>
                                <div class="col-sm-6">
                                    <input name="urgent_duration" type="Text" class="form-control" id="urgent_duration" value="30">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-6">
                                    <input name="highlight_project_fee" type="number" class="form-control" id="highlight_project_fee" value="5">
                                </div>
                            </div>
                            <div class="row form-group">
                                <label class="col-sm-4 control-label">Highlight Duration</label>
                                <div class="col-sm-6">
                                    <input name="highlight_duration" type="Text" class="form-control" id="highlight_duration" value="30">
